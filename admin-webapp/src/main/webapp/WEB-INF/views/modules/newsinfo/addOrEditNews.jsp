...
<%-- <div id="content" class="col-md-10"> --%>
	...
	<%-- <a href="${ctx}/news/list">跳转到新闻列表页面</a> --%>
	<br />
	...
	<c:if test="${newsInfo==null||newsInfo==''}">
	<form class="form-horizontal form-input" name="form1" role="form" action="${ctx}/news/save" method="POST">
	</c:if>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
			   ...
			   <c:if test="${tag.status!=2}">
			    ...
			    <br/><a href="${ctx}/tag/toAddorEdit?flag=1">添加新标签-></a>
			</div>
			<div class="col-sm-5 help-block Validform_checktip"></div>
		</div>
