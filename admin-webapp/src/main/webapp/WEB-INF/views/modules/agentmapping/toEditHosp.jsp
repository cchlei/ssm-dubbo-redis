...
<head>
<title>医院关联映射编辑</title>
</head>

<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="javascript:void(0)">医院关联映射编辑</a></li>
	</ul>
	<br />
	<form class="form-horizontal form-input" name="form" role="form" action="${ctx}/agentMapping/updateHospMapping" method="POST">
	    <input type="hidden" name="agentId" id="agentId" value="${myMappingBean.agentHospitalRef.agentId}"/>
	    <input type="hidden" name="myHospitalId" id="myHospitalId" value="${myMappingBean.agentHospitalRef.myHospitalId}"/>
		<div style="margin-left:300px;margin-top:10px">
		  ${myMappingBean.hosp.hospName}映射关系修改：<input type="text" name="hospitalId" id="hospitalId">
		<br/>
		<br/>
		<br/>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
