<%@ page contentType="text/html;charset=UTF-8"%><%@ include file="/WEB-INF/views/include/taglib.jsp"%><html>
	...
	<body>
	<span style="font-size:20px;font-weight:bold">${hospN}</span>
	<br><br><br><br>
		<ul>
			<!-- <li>
				<h4>多月日历</h4>
			...
			<li>
				...
				<br/>
				<br/>
				<input type="text" id="J_input" value="" style="*zoom:1;width:585px;" >
				<br/>
				<br/>
				<br/>
				<br/>
		...
		$(document).ready(function() {
			...
			function noGenSumb(){
				...
				var hospId= ${hospId};
				//var hospName123=${hospName};
				//alert(hospName123);
				$.confirm(message, function() {
					var url = ctx + "/holidays/saveHospDateFilter?result="+result+"&hospId="+hospId;
					$.ajax({
						type : "GET",
						url : url,
						dataType : "json",
						...
						success : function(data) {
							window.location.href="${ctx}/holidaysHosp/list?areaId=${areaId}&areaIdParent=${areaIdParent}&hospName=${hospName}&hospSimpleName=${hospSimpleName}&hospGraded=${hospGraded}&pageNum=${page.pageNum}&pageSize=${page.pageSize}";
